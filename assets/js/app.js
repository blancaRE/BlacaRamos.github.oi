...
<a class="navbar-brand" href="index.html">Blanca Ramos </a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/blanca-ramos-3228b3a9/" target="_blank" >
    ...
    <a class="social-button mail" href="mailto:bramelb@gmail.com" target="_blank">
    <i class="fa fa-envelope"aria-hidden="true"></i>               
    </a>


    <a class="social-button github" href="https://github.com/blancaRE/" target="_blank">
