...
const exp = [
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/TU_Wien1.png",
    place: "Vienna University of Technology",
    time: "(Jan 17- Dec, 2018)",
    desp: "<li> Design and program rural and urban scenarios to asses the performance over carrier frequencies.</li><li>Define KPIs performance metrics</li>",
  },
  {
    title: "Project Assistant",
    cardImage: "assets/images/experience-page/TU_Wien1.png",
    place: "Vienna University of Technology",
    time: "(Jan, 16 -  Dec, 16)",
    desp:"<li>Worked on the automated measurement setup for WLAN performance evaluation.</li><li>Assesment of routers performance with different sources of interference.</li>",
  },
];
